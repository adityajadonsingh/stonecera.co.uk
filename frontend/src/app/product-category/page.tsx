    ...
    <>
      ...
      <div className="px-10">
        <div className="grid grid-cols-4 gap-6">
          {
            categories.map((category, i) => <Link key={i+"key"} href={`/product-category/${category.slug}`}>
            <div className="card h-48 relative">
                <Image
                    src={process.env.NEXT_PUBLIC_MEDIA_URL+category.images[0]?.url || '/placeholder.png'}
